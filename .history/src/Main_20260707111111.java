            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    if (conceito == 1) {
                        ...
                        "Dentro dela é comum serem declarados atributos, que são as características e métodos, os comportamentos.\n" +
                        "Ela é uma estrutura fundamental que define um tipo de objeto, serve como modelo para criar objetos que compartilham características em comum,\n" +
                        "mas podem assumir estado próprio.");
                    } else if (conceito == 3) {
                        System.out.println("\nAtributos em Java");
                        System.out.println("Os atributos são as características de um objeto. Eles são declarados dentro de uma classe e\n"+
                        "representam os dados que esse objeto pode armazenar.\n" +
                        "Por exemplo, quando o atributo representa um texto, como cor ou modelo, utiliza-se o tipo String.\n" +
                        "Já para números inteiros, como quantidade ou ano, o tipo int é utilizado.\n");
                    } else if (conceito == 4) {
                        System.out.println("\nEncapsulamento em Java");
                        System.out.println("Encapsulamento é a técnica que esconde uma ideia, ou seja, não expõe detalhes internos para o usuário, tornando o sistema mais independente.\n" +
                        "Por exemplo, quando um controle remoto estraga apenas é trocado ou consertado o controle e não a televisão inteira. Nesse exemplo, acontece a forma clássica de encapsulamento, pois quando o usuário muda de canal não sabe que programação acontece entre a TV e o controle para efetuar essa ação.");
                    } else if (conceito == 5) {
