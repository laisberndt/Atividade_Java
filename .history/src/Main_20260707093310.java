        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    if (conceito == 1) {
                        System.out.println("\n POO Java POO refere-se ao uso da Programação Orientada a Objetos (POO) 
                        na linguagem de programação Java. É um modelo de desenvolvimento onde o código é organizado em \"objetos\" que representam entidades do mundo real, facilitando a reutilização, a manutenção e a organização de sistemas complexos");
                    }
                    break;
