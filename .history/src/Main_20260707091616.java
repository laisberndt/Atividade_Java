        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    if (operacao == 1) {
                        System.out.println("O resultado de " + num1 + " + " + num2 + " é " + calculo.somar());
                    } else if (operacao == 2) {
                        System.out.println("O resultado de " + num1 + " - " + num2 + " é " + calculo.subtrair());
                    } else if (operacao == 3) {
                        System.out.println("O resultado de " + num1 + " * " + num2 + " é " + calculo.multiplicar());
                    } else if (operacao == 4) {
                        if (num2 == 0) {
                            System.out.println("ERRO! Não pode ser feita a divisão por Zero!");
                            break;
                        } else {
                            System.out.println("O resultado de " + num1 + " / " + num2 + " é " + calculo.dividir());
                        }
                    } else {
