            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    if (conceito == 1) {
                        ...
                        System.out.println("\nAtributos em Java");
                        System.out.println("Os atributos são as características de um objeto. Eles são declarados dentro de uma classe e representam os dados que esse objeto pode armazenar. Por exemplo, quando o atributo representa um texto, como cor ou modelo, utiliza-se o tipo String. Já para números inteiros, como quantidade ou ano, o tipo int é utilizado.\r\n" + //);
                    } else if (conceito == 4) {
