            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    if (conceito == 1) {
                        ...
                        System.out.println("\nClasses em Java\n");
                        System.out.println("A classe é um elemento do código Java utilizado para representar objetos do mundo real. Dentro dela é comum serem declarados atributos, que são as características e métodos, os comportamentos. Ela é uma estrutura fundamental que define um tipo de objeto, serve como modelo para criar objetos que compartilham características em comum, mas podem assumir estado próprio.");
                    } else if (conceito == 3) {
                        System.out.println("\nAtributos em Java\n");
                    } else if (conceito == 4) {
